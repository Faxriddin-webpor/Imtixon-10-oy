          ...
          <div className="flex justify-between mx-[280px] mb-[100px]">
            <div className="card bg-white rounded-[30px] py-[25px] px-[40px]">
              ...
              >
                ...
                <option value="select">Ташкентская область</option>
                <option value="select">Андижан</option>
                <option value="select">Фергана</option>
                <option value="select">Бухара</option>
                <option value="select">Самарканд</option>
                <option value="select">Джизак</option>
                <option value="select">Навои</option>
                <option value="select">Наманган</option>
                <option value="select">Кашкадарья</option>
                <option value="select">Сурхандарья</option>
                <option value="select">Сырдарья</option>
                <option value="select">Каракалпакстан</option>
              </select>
              <br />
              <input
            ...
            <div>
              ...
              <Link to={"/zakaz"}>
                <button className="bg-black text-center py-[14px] w-[444px] text-white rounded-[10px]">
